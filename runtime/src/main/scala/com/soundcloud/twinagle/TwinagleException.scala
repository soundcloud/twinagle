...
sealed abstract case class ErrorCode(status: Status, desc: String)

object ErrorCode {

  //  TODO:  finagle flags maybe?
  /** The operation was cancelled. */
  object Canceled extends ErrorCode(Status.RequestTimeout, "canceled")
  ...
  object Unknown extends ErrorCode(Status.InternalServerError, "unknown")
  ...
  object InvalidArgument extends ErrorCode(Status.BadRequest, "invalid_argument")
  ...
  object DeadlineExceeded extends ErrorCode(Status.RequestTimeout, "deadline_exceeded")

  /** Some requested entity was not found. */
  object NotFound extends ErrorCode(Status.NotFound, "not_found")
  ...
  object BadRoute extends ErrorCode(Status.NotFound, "bad_route")

  /** An attempt to create an entity failed because one already exists. */
  object AlreadyExists extends ErrorCode(Status.Conflict, "already_exists")
  ...
  object PermissionDenied extends ErrorCode(Status.Forbidden, "permission_denied")

  /** The request does not have valid authentication credentials for the operation. */
  object Unauthenticated extends ErrorCode(Status.Unauthorized, "unauthenticated")

  /** Some resource has been exhausted, perhaps a per-user quota, or perhaps the entire file system is out of space. */
  object ResourceExhausted extends ErrorCode(Status.Forbidden, "resource_exhausted")
  ...
  object FailedPrecondition extends ErrorCode(Status.PreconditionFailed, "failed_precondition")

  /** The operation was aborted, typically due to a concurrency issue like sequencer check failures, transaction aborts, etc. */
  object Aborted extends ErrorCode(Status.Conflict, "aborted")
  ...
  object OutOfRange extends ErrorCode(Status.BadRequest, "out_of_range")

  /** The operation is not implemented or not supported/enabled in this service. */
  object Unimplemented extends ErrorCode(Status.NotImplemented, "unimplemented")
  ...
  object Internal extends ErrorCode(Status.InternalServerError, "internal")
  ...
  object Unavailable extends ErrorCode(Status.ServiceUnavailable, "unavailable")

  /** The operation resulted in unrecoverable data loss or corruption. */
  object Dataloss extends ErrorCode(Status.InternalServerError, "dataloss")
